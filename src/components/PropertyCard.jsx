 ...
 *
 * Reusable card displaying a property summary with NPR pricing.
 * Matches the screenshot design: image with type badge,
 * title, location with icon, NPR price, and View Details button.
 */
